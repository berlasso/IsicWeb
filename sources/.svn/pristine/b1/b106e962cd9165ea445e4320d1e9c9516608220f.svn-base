...
/// <summary>
/// Gets or sets the Id of the PBClaseAspectoCabello.
/// </summary>
...
/// <summary>
/// Gets or sets the Descripcion of the PBClaseAspectoCabello.
/// </summary>
...
/// <summary>
///Gets or sets a collection of <see cref="Busqueda" /> instances for the PBClaseAspectoCabello.
/// </summary>
...
/// <summary>
///Gets or sets a collection of <see cref="PersonasDesaparecidas" /> instances for the PBClaseAspectoCabello.
/// </summary>
...
/// <summary>
///Gets or sets a collection of <see cref="PersonasHalladas" /> instances for the PBClaseAspectoCabello.
/// </summary>
