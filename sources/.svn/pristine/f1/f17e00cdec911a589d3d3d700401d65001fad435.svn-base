...
public partial class PBClaseTipoJurisdiccionCausa{
...
/// <summary>
/// Gets or sets the id of the PBClaseTipoJurisdiccionCausa.
/// </summary>
...
/// <summary>
/// Gets or sets the Descripcion of the PBClaseTipoJurisdiccionCausa.
/// </summary>
...
/// <summary>
///Gets or sets a collection of <see cref="PersonasDesaparecidas" /> instances for the PBClaseTipoJurisdiccionCausa.
/// </summary>
...
/// <summary>
///Gets or sets a collection of <see cref="PersonasHalladas" /> instances for the PBClaseTipoJurisdiccionCausa.
/// </summary>
