...
public static class HtmlModelBindingHelperExtensions
{
    ...
    public static System.IDisposable BeginCollectionItem(this HtmlHelper html, string collectionName)
    {
        ...
        html.ViewContext.Writer.WriteLine(string.Format("<input " + "type=\"hidden\" name=\"{0}.index\" autocomplete=\"off\" value=\"{1}\" />", !string.IsNullOrEmpty(previousPrefix) ? 
    ...
    private class HtmlFieldPrefix : System.IDisposable
    {
